...
class DressesSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Dresses
        fields = ['id', 'product_image', 'designer_name','actual_price', 'description','status' ]
...
class CartItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Cart_Items
        fields = ['id', 'date_added', 'dress', 'booking_start_date', 'booking_end_date', 'booking_for_n_days', 'price', 'error']

    def get_error(self, obj):
        if not Cart_items_tasks.booking_days_is_available(obj.dress , obj.booking_start_date, obj.booking_end_date):
