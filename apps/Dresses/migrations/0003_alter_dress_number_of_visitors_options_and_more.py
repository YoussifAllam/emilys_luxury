...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AlterModelOptions(
            ...
            options={'verbose_name': 'Dress number of visitors', 'verbose_name_plural': 'Dress number of visitors'},
        ),
        migrations.AlterModelOptions(
            name='dresses',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dress', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='review_set', to='Dresses.dresses')),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='User_review_set', to=settings.AUTH_USER_MODEL)),
            ],
            options={
